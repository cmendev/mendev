...
import Spring from "../components/icons/technologies/Spring.astro";
...
export const TAGS = {
  JAVASCRIPT: {
    name: "JavaScript",
    class: "text-yellow-500/80 bg-white",
    icon: JavaScript,
  },
  REACT: {
    name: "React",
    class: "text-blue-500/80 bg-white",
    icon: React,
  },
  CSS: {
    name: "CSS",
    class: "text-blue-400/80 bg-white",
    icon: CSS,
  },
  HTML: {
    name: "HTML",
    class: "text-orange-500/80 bg-white",
    icon: HTML,
  },
  TYPESCRIPT: {
    name: "TypeScript",
    class: "text-blue-600/80 bg-white",
    icon: TypeScript,
  },
  NEXTJS: {
    name: "Nextjs",
    class: "text-black/80 bg-white",
    icon: Nextjs,
  },
  TAILWINDCSS: {
    name: "Tailwindcss",
    class: "text-teal-500/80 bg-white",
    icon: TailwindCSS,
  },
  JAVA: {
    name: "Java",
  ...
  SPRING: {
    name: "Spring",
    class: "text-[#6cb43c] bg-white",
    icon: Spring,
  },
  THYMELEAF: {
    name: "Thymeleaf",
    class: "text-green-500/80 bg-white",
    icon: Thymeleaf,
  },
  GIT: {
    name: "Git",
